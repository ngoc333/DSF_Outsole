...
namespace OS_DSF
{
    public partial class FORM_SMT_OS_LEADTIME_YEAR : Form
    {
        public FORM_SMT_OS_LEADTIME_YEAR()
        {
            InitializeComponent();
            lblTitle.Text = "Lead Time By Year";
           
        }

        public static string _sProcess = "OSP";
        public int iCount = 0;
        ...
        public DataSet SEL_OS_PROD_MONTH(string ARG_QTYPE, string ARG_YMD, string ARG_OP)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B_LEADTIME.SEL_LEAD_TIME_BY_YEAR";
                ...
                if (arg_dt != null && arg_dt.Rows.Count > 0)
                {
                  //  string name;
                    ...
                    if (arg_dt.Rows.Count > 0)
                    {
                        ...
                        {
                            band.Caption = arg_dt.Rows[i][0].ToString().Replace("_", "\n");
                            i++;
        ...
        private void BindingData(string arg_op)
        {
            ...
            {
                grdView.Refresh();
                DataSet ds = SEL_OS_PROD_MONTH("Q", uc_year.GetValue().ToString(), arg_op);
        ...
        {
            Form fc = Application.OpenForms["FORM_SMT_OS_LEADTIME"];
            if (fc != null)
            {
            ...
            {
                FORM_SMT_OS_LEADTIME f = new FORM_SMT_OS_LEADTIME();
                f.Show();
                this.Hide();
            }
        }
        ...
        {
            Form fc = Application.OpenForms["FORM_SMT_OS_LEADTIME_WEEK"];
            if (fc != null)
            {
        ...
        {
            Form fc = Application.OpenForms["FORM_SMT_OS_LEADTIME_MONTH"];
            if (fc != null)
            {
