...
namespace OS_DSF
{
    public partial class FRM_SMT_OS_PROD_MONTH : Form
    {
        public FRM_SMT_OS_PROD_MONTH()
        {
            InitializeComponent();
        }
        ...
        {            
            ...
            lblTitle2.Text = "- Pcard Production status by Month";
        }
        ...
        private void formatband()
        {
            try
            {
                ...
                dtsource = db.SEL_OS_PROD_MONTH("H",APS_YN, uc_month.GetValue().ToString(), "");                
        ...
        private void BindingData(string arg_op)
        {
            grdView.Refresh();
            DataTable dtsource = null;
            dtsource = db.SEL_OS_PROD_MONTH("Q",APS_YN, uc_month.GetValue().ToString(), arg_op);
            formatband();
        ...
        {
            DataTable dt = null;
            dt = db.SEL_OS_PROD_MONTH("C",APS_YN, uc_month.GetValue().ToString(), arg_op);
            ...
            try
            {
                ...
                if (((DevExpress.XtraEditors.SimpleButton)sender).Tag.ToString().Equals("0"))
                {
                    ((DevExpress.XtraEditors.SimpleButton)sender).Enabled = false;
                     ...
                     APS_YN = "Y";
                     lblTitle2.Text = "- APS Production status by Month";
                }
                else
                {
                    ((DevExpress.XtraEditors.SimpleButton)sender).Enabled = false;
