...
namespace OS_DSF
{
    public partial class FRM_SMT_IP_PROD_MONTH : Form
    {
        public FRM_SMT_IP_PROD_MONTH()
        {
            InitializeComponent();
        }
        ...
        void DWMYClick(string ButtonCap, string ButtonCD)
        {
            ...
            switch (ButtonCD)
            {
                ...
                case "M":
                    this.Close();
                    Form fc1 = Application.OpenForms["FRM_SMT_IP_PROD_MONTH"];
                    if (fc1 != null)
                        fc1.Show();
                    else
                    {
                        FRM_SMT_IP_PROD_MONTH f1 = new FRM_SMT_IP_PROD_MONTH();
                        f1.Show();
                    }
                    break;
                case "Y":
