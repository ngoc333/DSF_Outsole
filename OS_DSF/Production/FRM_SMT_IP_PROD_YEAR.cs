...
namespace OS_DSF
{
    public partial class FRM_SMT_IP_PROD_YEAR : Form
    {
        public FRM_SMT_IP_PROD_YEAR()
        {
            InitializeComponent();
        }
        ...
        void DWMYClick(string ButtonCap, string ButtonCD)
        {
            ...
            switch (ButtonCD)
            {
                ...
                case "Y":
                    this.Close();
                    Form fc2 = Application.OpenForms["FRM_SMT_IP_PROD_YEAR"];
                    if (fc2 != null)
                        fc2.Show();
                    else
                    {
                        FRM_SMT_IP_PROD_YEAR f2 = new FRM_SMT_IP_PROD_YEAR();
                        f2.Show();
                    }
                    break;
            }
