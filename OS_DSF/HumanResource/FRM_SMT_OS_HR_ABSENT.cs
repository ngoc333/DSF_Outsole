...
namespace OS_DSF
{
    public partial class FRM_SMT_OS_HR_ABSENT : Form
    {
        public FRM_SMT_OS_HR_ABSENT()
        {
            InitializeComponent();
            addUC();
      ...
      /*  private void loadDataGridTunover(DataTable argDt)
        ...
        {
            System.Data.DataSet ds = GET_DATA("OSP");
        ...
        private void FRM_SMT_HR_ABSENT_Load(object sender, EventArgs e)
        {
            ...
            lblTitle.Text = "Outsole Human Attendance";
        ...
        private void axfpAbsent_Advance(object sender, AxFPUSpreadADO._DSpreadEvents_AdvanceEvent e)
        {
