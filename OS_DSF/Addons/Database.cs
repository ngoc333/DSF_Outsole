...
namespace OS_DSF.Addons
{
    public class Database
    {
        ...
        public DataTable SEL_OSD_DATA(string ARG_QTYPE)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1_PHUOC.M_INTERNAL_OSD_SELECT";
        ...
        public DataTable SEL_OS_PRODUCTION_DATA(string ARG_QTYPE)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1_PHUOC.OUTSOLE_PRODUCTION_SELECT";
        ...
        public DataTable SEL_OS_INV_DATA(string ARG_QTYPE)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1_PHUOC.OUTSOLE_INV_SELECT";
        ...
        public DataTable SEL_OS_POD_DATA(string ARG_QTYPE)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1_PHUOC.OUTSOLE_POD_SELECT";
        ...
        public DataTable SEL_OS_ABSENT_DATA(string ARG_QTYPE)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1_PHUOC.OUTSOLE_HR_SELECT";
        ...
        public DataTable SEL_OS_PROD_YEAR(string ARG_QTYPE,string ARG_APS_YN, string ARG_YMD, string ARG_OP)
        {
            COM.OraDB MyOraDB = new COM.OraDB();
            DataSet ds_ret;
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1.SP_OS_PROD_YEAR_V3";
        ...
        public DataTable SEL_OS_INVENTORY(string ARG_QTYPE, string ARG_OP)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1.SP_OS_INVENTORY";
        ...
        public DataTable SEL_OS_TOPO_DAILY(string ARG_QTYPE, string ARG_OP)
        {
            COM.OraDB MyOraDB = new COM.OraDB();
            DataSet ds_ret;
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1.SEL_TOPO_DAILY";
        ...
        public static DataTable SEL_OS_APS_PLAN_ACTUAL(string arg_wh, string arg_date, string arg_shift)
        {
            COM.OraDB MyOraDB = new COM.OraDB();
            System.Data.DataSet ds_ret;
