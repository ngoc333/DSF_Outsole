...
namespace OS_DSF
{
    public partial class FORM_OS_KPI_PERFOMANCE : Form
    {
        ...
        private void setImage(Button arg_cmd)
        {
            ...
            {
                arg_cmd.BackgroundImage = OS_DSF.Properties.Resources.arrow_165_xxl;
            }
            else
            {
                arg_cmd.BackgroundImage = OS_DSF.Properties.Resources.arrow_165_down;
            }
        ...
        private DataTable SELECT_KPI_PER()
        {
            ...
            try
            {
                ...
                MyOraDB.Parameter_Values[0] = "OSP";
        ...
        private void FORM_IPEX3_LOGISTIC_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd_C5.Visible = false;
                cmd_C6.Visible = false;
