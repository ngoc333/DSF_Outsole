...
namespace OS_DSF
{
    public partial class FRM_SMT_DM_OSD_MONTH : Form
    {
        public FRM_SMT_DM_OSD_MONTH()
        {
            InitializeComponent();
        }
        ...
        private void formatband()
        {
            try
            {
                ...
                dtsource = db.SEL_OS_OSD_MONTH_V2("H", uc_month.GetValue().ToString(), "");
        ...
        private void BindingData(string arg_op)
        {
            grdView.Refresh();
            DataTable dtsource = null;
            dtsource = db.SEL_OS_OSD_MONTH_V2("Q", uc_month.GetValue().ToString(), arg_op);
            formatband();
        ...
        private void bindingdatachart(string arg_op)
        {
            ...
            {
                DataTable dt = null;
                dt = db.SEL_OS_OSD_MONTH_V2("C", uc_month.GetValue().ToString(), arg_op);
