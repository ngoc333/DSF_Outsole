...
namespace OS_DSF
{
    public partial class FORM_OS_DEFFECTIVE_STATUS_YEAR: Form
    {
        #region Declare
        int iNumRow = 0;
       ...
       // int _time = 0;
        ...
        #region Creation
        public FORM_OS_DEFFECTIVE_STATUS_YEAR(int arg_idx = 0)
        {
            InitializeComponent();
            idx_form = arg_idx;
        }
        ...
        {
            //flg.Hide();
            //OS_DSF.ClassLib.WinAPI.AnimateWindow(flg.Handle, 500, OS_DSF.ClassLib.WinAPI.getSlidType("2"));
            //flg.Show();
        }
        ...
        private DataTable select_deffect_monitor(string sYear)
        {
            ...
            MyOraDB.Process_Name = "MES.PKG_SMT_OS_DEFECTIVE.SEL_OS_DEFECT_MONITOR_YEAR";
        ...
        private DataTable select_chart_1(string arg_year)
        {
            ...
            COM.OraDB MyOraDB = new COM.OraDB();
            MyOraDB.ReDim_Parameter(2);
            MyOraDB.Process_Name = "MES.PKG_SMT_OS_DEFECTIVE.SEL_CHART_1_YEAR";
        ...
        private DataTable select_chart_2(string arg_year)
        {
            ...
            COM.OraDB MyOraDB = new COM.OraDB();
            MyOraDB.ReDim_Parameter(2);
            MyOraDB.Process_Name = "pkg_DMC.sel_chart_2_year";
        ...
        private DataTable select_chart_3(string arg_year)
        {
            ...
            COM.OraDB MyOraDB = new COM.OraDB();
            MyOraDB.ReDim_Parameter(2);
            MyOraDB.Process_Name = "pkg_DMC.sel_chart_3_year";
        ...
        #region Event
        private void FORM_OS_DEFFECTIVE_STATUS_YEAR_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void FORM_OS_DEFFECTIVE_STATUS_YEAR_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                //try
        ...
        {
            //OS_DSF.ComVar._frm_home.Show();            
            this.Hide();
        }

        private void cmdMonth_Click(object sender, EventArgs e)
        {
            //OS_DSF.ComVar._frmDefective.Show();
            this.Hide();
        }
        ...
        {            
            Form fc1 = Application.OpenForms["FORM_OS_DEFFECTIVE_STATUS"];
            if (fc1 != null)
                fc1.Show();
            else
            {
                FORM_OS_DEFFECTIVE_STATUS f1 = new FORM_OS_DEFFECTIVE_STATUS();
                f1.Show();
            }
            this.Hide();
        }
