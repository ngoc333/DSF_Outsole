...
namespace OS_DSF
{
    public partial class FRM_SMT_OS_OSD_YEAR : Form
    {
        public FRM_SMT_OS_OSD_YEAR()
        {
            InitializeComponent();
        }
        ...
        private void formatband()
        {
            try
            {
                ...
                dtsource = db.SEL_OS_OSD_YEAR("H", uc_year.GetValue().ToString(), "");
        ...
        private void BindingData(string arg_op)
        {
            grdView.Refresh();
            DataTable dtsource = null;
            dtsource = db.SEL_OS_OSD_YEAR("Q", uc_year.GetValue().ToString(), arg_op);
            //formatband();
        ...
        private void bindingdatachart(string arg_op)
        {
            ...
            {
                DataTable dt = null;
                dt = db.SEL_OS_OSD_YEAR("C", uc_year.GetValue().ToString(), arg_op);
