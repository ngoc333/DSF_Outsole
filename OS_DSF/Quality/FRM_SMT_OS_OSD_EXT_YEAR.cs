...
namespace OS_DSF
{
    public partial class FRM_SMT_OS_OSD_EXT_YEAR : Form
    {
        public FRM_SMT_OS_OSD_EXT_YEAR()
        {
            InitializeComponent();
        }
        ...
        void DWMYClick(string ButtonCap, string ButtonCD)
        {
            ...
            switch (ButtonCD)
            {
                ...
                case "Y":
                    this.Close();
                    Form fc1 = Application.OpenForms["FRM_SMT_OS_OSD_EXT_YEAR"];
                    if (fc1 != null)
                        fc1.Show();
                    else
                    {
                        FRM_SMT_OS_OSD_EXT_YEAR f1 = new FRM_SMT_OS_OSD_EXT_YEAR();
                        f1.Show();
                    }
                    break;
            }
        ...
        private void formatband()
        {
            try
            {
                ...
                dtsource = db.SEL_OS_OSD_EXT_YEAR("H", "");
        ...
        private void BindingData(string arg_op)
        {
            grdView.Refresh();
            DataTable dtsource = null;
            dtsource = db.SEL_OS_OSD_EXT_YEAR("Q", arg_op);
            //formatband();
        ...
        {
            DataTable dt = null;
            dt = db.SEL_OS_OSD_EXT_YEAR("C", arg_op);
