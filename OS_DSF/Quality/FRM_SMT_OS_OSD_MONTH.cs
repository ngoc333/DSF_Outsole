...
namespace OS_DSF
{
    public partial class FRM_SMT_OS_OSD_MONTH : Form
    {
        public FRM_SMT_OS_OSD_MONTH()
        {
            InitializeComponent();
        }

        FRM_OS_ANALYSIS FRMANA = new FRM_OS_ANALYSIS();
        ...
        private void formatband()
        {
            try
            {
                ...
                dtsource =  db.SEL_OS_OSD_MONTH("H", uc_month.GetValue().ToString(), "");
        ...
        private void BindingData(string arg_op)
        {
            grdView.Refresh();
            DataTable dtsource = null;
            dtsource = db.SEL_OS_OSD_MONTH("Q", uc_month.GetValue().ToString(), arg_op);
            formatband();
        ...
        private void bindingdatachart(string arg_op)
        {
            ...
            {
                DataTable dt = null;
                dt = db.SEL_OS_OSD_MONTH("C", uc_month.GetValue().ToString(), arg_op);
